...
export default function CVVerification() {
    ...
    const filtered = samplePublications
        .filter(pub => filterStatus === 'All' || pub.status === filterStatus)
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-6 p-4 min-h-screen bg-gray-100">
            ...
            <div className="md:col-span-4 p-4">
                ...
                {paginated.map((pub, idx) => (
                    <div key={idx} className="grid grid-cols-1 md:grid-cols-6 mb-2 p-4 h-fit bg-white rounded shadow">
