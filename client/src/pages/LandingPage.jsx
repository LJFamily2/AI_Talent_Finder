...
function LandingPage() {
  ...
  return (
    <div className="w-full min-h-screen relative">
      ...
      <div className="w-full h-180 mt-18 flex justify-center items-center overflow-clip z-0 relative">
        ...
        >
          {!hideHeading && (
            <>
              <h1
                className="text-white text-6xl font-bold mb-5"
              ...
              {!videoEnded && (
                <button
                  className="text-white text-xl underline focus:outline-none cursor-pointer mt-4 opacity-70"
                  onClick={() => {
        ...
        {videoEnded && (
          <div className="absolute text-center bottom-8">
            <button
              className="text-white text-xl underline focus:outline-none cursor-pointer opacity-100"
              onClick={() => {
                const el = document.getElementById('hr-features');
                if (el) {
                  el.scrollIntoView({ behavior: 'smooth' });
      ...
      <hr id="hr-features" className="w-2/3 border-[#E60028] border-2 my-15 place-self-center" />

      <h2 className="text-center font-bold text-3xl text-[#000054] mb-10 mt-20"> What can we provide?</h2>
      ...
      <div className="w-full md:w-5/6 h-max flex flex-col md:flex-row gap-8 md:gap-15 mx-auto text-white px-4 md:px-0">
          {/* Feature 2: Verify candidate CVs */}
          <div className="w-full md:w-1/2 sm:hover:scale-100 h-full bg-[#000054] rounded-2xl pt-10 shadow-md hover:scale-105 transition-transform duration-300 shadow-md mb-8 md:mb-0 sm:px-5">
          ...
          <div className="w-full md:w-1/2 sm:hover:scale-100 bg-[#000054] rounded-2xl shadow-md grow flex flex-col justify-between hover:scale-105 transition-transform duration-300 shadow-md sm:px-5">
                  ...
                  <div className="bg-white w-full py-8 px-0 md:px-5 rounded-b-lg border-gray-200 border-1 flex flex-col md:flex-row justify-around gap-4 md:gap-0">
                          ...
                          <div className="flex flex-col items-center md:items-start">
                                  ...
                                  <img src={clickIcon} className="w-14 md:w-18 h-auto justify-self-end relative bottom-3" alt="Click Icon"></img>
                          </div>
                  </div>
          </div>
      </div>
      ...
      <div className="w-screen h-max bg-[#F3F4F5] text-[#000054] text-xl text-center py-15">
          <p>We extract the <b>essence</b> of multiple large databases <b>used by millions</b> around the world</p>
          <div className="w-3/4 flex flex-wrap justify-between items-center mt-2 mx-auto gap-4 md:gap-0">
              <img src={scopusLogo} alt="Scopus Logo" className="h-16 md:h-27 mx-2 md:mx-4 inline-block w-auto" />
              <img src={orcidLogo} alt="ORCID Logo" className="h-12 md:h-18 mx-2 md:mx-4 inline-block w-auto" />
              <img src={openAlexLogo} alt="OpenAlex Logo" className="h-8 md:h-11 mx-2 md:mx-4 inline-block w-auto" />
              <img src={googleScholarLogo} alt="Google Scholar Logo" className="h-18 md:h-30 mx-2 md:mx-4 inline-block w-auto" />
          </div>
      ...
      <div className="w-full h-max text-[#000054] text-center py-20 px-4">
          <h3 className="text-3xl mb-13"> We strive for <b>high quality</b> <br></br>in all aspects of our product</h3>
          <div className="w-2/3 md:w-5/6 sm:w-full bg-[#000054] text-white mx-auto py-15 px-20 rounded-2xl flex gap-10">
      ...
      <div className="bg-[#F3F4F6] w-full h-max text-[#000054] text-center py-20">
          ...
          <div className="w-2/3 md:w-5/6 h-max mx-auto mb-10 flex flex-col text-justify">
          <Accordion>
              <AccordionSummary
